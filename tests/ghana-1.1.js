// The true compile product (pretty-printed)
KeymanWeb.KR(new Keyboard_ghana());
function Keyboard_ghana() {
    this.KI = "Keyboard_ghana";
    this.KN = "Ghana";
    this.KV = {
        F: ' 1em "Arial"',
        K102: 0,
    ...
    this.KDU = 0;
    this.KH = "This is a keyboard for the languages of Ghana.";
    this.KM = 0;
    this.KBVER = "1.1";
    this.KVKL = {
        "tablet": {
    ...
    this.s17 = " eonEONIuizZgG";
    this.s18 = ";ɛɔŋƐƆŊƏʋɩʒƷɣƔ";
    this.KVER = "10.0.852.0";
    ...
    this.g1 = function(t, e) {
        var k = KeymanWeb
          , r = 1
          , m = 0;
        if (k.KDM(1, t, 0) && k.KA(0, k.KC(1, 1, t), this.s17)) {
            m = 1;
